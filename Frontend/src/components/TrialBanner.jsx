...
const TrialBanner = () => {
    ...
    useEffect(() => {
        const fetchStatus = async () => {
            try {
                const res = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5006/api'}/Trial/status`);
                if (res.ok) {
                ...
                <div className="flex gap-2 mt-2">
                    ...
                    <button
                        onClick={async () => {
                            ...
                            const res = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5006/api'}/Trial/activate`, {
                                method: 'POST',
