...
const AlmacenModal = ({ isOpen, onClose, onSave, initialData, error: externalError }) => {
    ...
    useEffect(() => {
        if (isOpen) {
            setCurrentItem(initialData || { codigo: '', nombre: '', direccion: '', ciudad: '', activo: true });
            setLocalError('');
        }
    }, [isOpen, initialData]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error(err);
            setLocalError(`Error al guardar Almacén`);
        }
    };
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
                <div className="flex items-center justify-between p-4 border-b">
                    <h3 className="text-lg font-semibold text-gray-800">
                        {currentItem.id ? 'Editar' : 'Nuevo'} Almacén
                    </h3>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            onChange={(e) => setCurrentItem({ ...currentItem, ciudad: e.target.value })}
                            placeholder="Ciudad"
                        />
                    </div>
