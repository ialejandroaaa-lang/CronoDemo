...
const UsuariosList = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const [usersResp, groupsResp] = await Promise.all([
                fetch(`${((import.meta.env.VITE_API_URL && import.meta.env.VITE_API_URL !== 'undefined') ? import.meta.env.VITE_API_URL : '/api')}/SecurityEditor/users`, {
                    headers: { 'Authorization': `Bearer ${user.token}` }
                }),
                fetch(`${((import.meta.env.VITE_API_URL && import.meta.env.VITE_API_URL !== 'undefined') ? import.meta.env.VITE_API_URL : '/api')}/SecurityEditor/groups`, {
                    headers: { 'Authorization': `Bearer ${user.token}` }
                })
            ]);
    ...
    const handleSave = async (e) => {
        ...
        try {
            const url = selectedUser
                ? `${((import.meta.env.VITE_API_URL && import.meta.env.VITE_API_URL !== 'undefined') ? import.meta.env.VITE_API_URL : '/api')}/SecurityEditor/users/${selectedUser.id}`
                : `${((import.meta.env.VITE_API_URL && import.meta.env.VITE_API_URL !== 'undefined') ? import.meta.env.VITE_API_URL : '/api')}/SecurityEditor/users`;
    ...
    const handleResetPassword = async () => {
        ...
        setSaving(true);
        try {
            const resp = await fetch(`${((import.meta.env.VITE_API_URL && import.meta.env.VITE_API_URL !== 'undefined') ? import.meta.env.VITE_API_URL : '/api')}/SecurityEditor/users/${selectedUser.id}/reset-password`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${user.token}`
